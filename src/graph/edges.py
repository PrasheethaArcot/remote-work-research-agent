...
def build_graph():
    ...
    graph.add_node("json_generator_node", json_generator_node)

    # Set entry and finish nodes
    graph.set_entry_point("plan_node")
    graph.set_finish_point("json_generator_node")
    ...
    graph.add_edge("report_generator_node", "json_generator_node")
...
edges = [
    ...
    (report_generator_node, json_generator_node),
]
