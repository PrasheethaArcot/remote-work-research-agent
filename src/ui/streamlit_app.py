...
if st.button("Run Research"):
    if query:
        with st.spinner('🔎 Searching...'):
            ...
            #Two-tab layout
            tab1, tab2 = st.tabs(["📄 Report", "🧠 Graph"])
            ...
            with tab2:
                ...
                node_styles = [
                    NodeStyle("QUERY", "#FFC107","name", "person"),
                    NodeStyle("SUBTOPIC", "#00BCD4","content", "description"),
                    NodeStyle("DOCUMENT", "#8BC34A", "content", "description"),
                ]
