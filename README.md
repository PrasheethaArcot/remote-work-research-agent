...
```markdown
The Research Agent generates a structured output consisting of:
📝 A markdown-formatted summary report with section headings
🤖 A collapsible Model Thinking section showing internal reasoning
🔗 APA-style citations with clickable links to source documents
🕸️ A dynamic knowledge graph showing entities and relationships

✅ Example Output
Research Summary Report
Battery Innovation
Recent developments in battery technology focus on improving energy density, lifecycle durability, and sustainability. Companies are investing in solid-state batteries, lithium-sulfur chemistry, and graphene-enhanced electrodes to overcome the limitations of traditional lithium-ion designs.

📚 Citations
Smith, J. & Lee, R. (2023). Advances in Battery Storage. PDF
Tanaka, Y. et al. (2022). Graphene Electrodes in Lithium Cells. PDF
